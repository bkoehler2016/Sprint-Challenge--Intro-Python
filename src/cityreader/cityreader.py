...
coordinate1 = input("Enter lat and lon values for the first co-ordinate seperated by commas: ").split(",")
coordinate2 = input("Enter lat and lon values for the second co-ordinate seperated by commas: ").split(",")
